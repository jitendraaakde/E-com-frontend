    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-8xl w-full mx-auto">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-1/2 p-6 lg:p-9 flex flex-col justify-between bg-gray-50">
            <div className="space-y-4"> {/* Reduced the space between elements */}
              <div>
                <h2 className="text-2xl font-bold text-primary">LuxeWear</h2>
                <h1 className="text-3xl lg:text-4xl font-extrabold text-gray-800 mt-1">Ethereal Silk Blouse</h1>
            ...
            <div className="space-y-4 mt-4"> {/* Reduced the margin-top and spacing */}
              <div className="flex items-center space-x-4">
